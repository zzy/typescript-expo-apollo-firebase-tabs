...
export class ConstantsScreen extends Component<NavigationScreenProps, State> {
  ...
  public render() {
    ...
    return (
      ...
      >
        <Text>deviceWidth: "{deviceSize.width}"</Text>
        <Text>deviceHeight: "{deviceSize.height}"</Text>
        <Text>deviceScale: "{deviceSize.scale}"</Text>
        <Text>deviceFontScale: "{deviceSize.fontScale}"</Text>
