...
sudo docker network create -d bridge --subnet 172.25.0.0/16 bigdata
sudo docker run -itdP --name bdm2 --hostname bdm2 --network=bigdata --ip=172.25.5.1 zzy/bigdata
